...
class UltimateHybridStrategyPro2h(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = '2h'
    can_short = False

    # Parametri ottimizzati (2h)
    supertrend_period = IntParameter(7, 14, default=12, space='buy')
    supertrend_multiplier = DecimalParameter(2.0, 4.0, default=2.5, decimals=1, space='buy')
    entry_cooldown = IntParameter(1800, 7200, default=5558, space='buy')
