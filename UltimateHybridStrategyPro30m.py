...
class UltimateHybridStrategyPro30m(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = '5m'
    can_short = False

    supertrend_period = IntParameter(7, 14, default=8, space='buy')
    supertrend_multiplier = DecimalParameter(2.0, 4.0, default=3.9, decimals=1, space='buy')
    entry_cooldown = IntParameter(1800, 7200, default=4626, space='buy')
    ...
    emergency_stop_pct = DecimalParameter(-0.1, -0.05, default=-0.07, decimals=2, space='sell')
