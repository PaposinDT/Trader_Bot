...
class UltimateHybridStrategyPro1h(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = '1h'
    can_short = False

    # Valori ottimizzati da Hyperopt
    supertrend_period = IntParameter(7, 14, default=11, space='buy')
    supertrend_multiplier = DecimalParameter(2.0, 4.0, default=3.9, decimals=1, space='buy')
    entry_cooldown = IntParameter(1800, 7200, default=6889, space='buy')

    exit_profit_pct = DecimalParameter(0.03, 0.1, default=0.03, decimals=2, space='sell')
    emergency_stop_pct = DecimalParameter(-0.1, -0.05, default=-0.1, decimals=2, space='sell')
